...
theme: /
    state: start
        ...
        a: Привет. Со мной ты можешь научиться определять птиц по голосу. Я включаю запись, а вы угадываете что это за птица. Начнем?
    ...
    state: what
            q: Что ты умеешь
            a: Я могу помочь вам научиться определять птиц по голосам. Я включаю запись, а вы угадываете что это за птица.
    state: help
            q: Помощь
            a: Это навык "Занимательная орнитология". Я могу помочь вам научиться определять птиц по голосам. Я включаю запись, а вы угадываете что это за птица. 